...
export class MainMenu extends AGUIScreen {
  constructor(readonly prev: IGUIScreen | null = null) {
    ...
    this.items = [
      ...
      new BasicText(
        {
          x: MENU_BASE_X + ITEM_SPACING + ITEM_HEIGHT * 2,
          y: MENU_BASE_Y + ITEM_HEIGHT / 2,
        },
        GetText("MainMenu::MainSwitch")
      ),
      ...
      new TextRoundButton(
        ...
        GetText("MainMenu::PersonalitySetting"),
        () => GUISetting.setScreen(new PersonaSetting(this))
      ),
      new TextRoundButton(
        {
          x: MENU_BASE_X,
      ...
      new IconRoundButton(
        ...
        Styles.Dialog.roundRadius,
        "github",
        () => window.open(GIT_REPO)
      ),
    ];
  }
}
