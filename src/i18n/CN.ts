export const CNConfig: Record<TextTags, string> = {
    ...
    "RenamePopup::PersonaName::Title": "输入新名称",
    "PersonaInfo::BlackList": "编辑黑名单",
    "MemberListPopup::PersonaBlackList::Title": "编辑人格黑名单列表",
    "TriggerMode::activity": "互动",
    "TriggerMode::orgasm": "高潮",
    "TriggerMode::spicer": "趣味",
    "TriggerMode::event": "事件",
    ...
    "TriggerInfo::Orgasm::Type": "高潮触发模式：",
    "TriggerInfo::Orgasm::Type::Orgasmed": "高潮",
    "TriggerInfo::Orgasm::Type::Ruined": "拒绝",
    "TriggerInfo::Orgasm::Type::Resisted": "忍耐",
    "TriggerInfo::Orgasm::Type::Any": "任意",
    "TriggerInfo::RoomEvent::Type": "事件触发模式：",
    "TriggerInfo::RoomEvent::Type::Join": "加入聊天",
    "TriggerInfo::RoomEvent::Type::Leave": "离开聊天",
    "MemberListPopup::AllowIDs::Title": "编辑触发玩家列表",
